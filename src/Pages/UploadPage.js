  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.autoGeneratedCombinations > 0) {
          alert(`${data.autoGeneratedCombinations} yeni kombinasyon oluşturuldu! Kombinasyonları görüntülemek için yönlendiriliyorsunuz.`);
        }
